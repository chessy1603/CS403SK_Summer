<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="Scheduler.aspx.cs" Inherits="DXApplication1.SchedulerModule" Title="Scheduler" %>

<%@ Register Assembly="DevExpress.Web.ASPxScheduler.v24.1, Version=24.1.3.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxScheduler" TagPrefix="dx" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:ObjectDataSource ID="AppointmentDataSource" runat="server" DataObjectTypeName=" DXApplication1.Model.SchedulerAppointment"
        TypeName=" DXApplication1.Model.AppointmentDataSourceHelper"
    ...
    <asp:ObjectDataSource ID="ResourcesDataSource" runat="server" DataObjectTypeName=" DXApplication1.Model.SchedulerResource"
        TypeName=" DXApplication1.Model.ResourceDataSourceHelper"
