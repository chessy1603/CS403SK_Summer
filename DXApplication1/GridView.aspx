<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="GridView.aspx.cs" Inherits="DXApplication1.GridViewModule" Title="GridView" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:ObjectDataSource ID="GridViewDataSource" runat="server" DataObjectTypeName=" DXApplication1.Model.Issue"
        TypeName=" DXApplication1.Model.DataProvider"
        SelectMethod="GetIssues" InsertMethod="AddNewIssue" UpdateMethod="UpdateIssue"></asp:ObjectDataSource>

    <asp:ObjectDataSource ID="ContactsDataSource" runat="server" DataObjectTypeName=" DXApplication1.Model.Contact"
        TypeName=" DXApplication1.Model.DataProvider"
